...
class VoterGenerator {
  ...
  generateVoter() {
    ...
    let circuitId = this.circuits[Math.floor(Math.random()*this.circuits.length)].id;

    let voter = { ci, credential, name, lastName, gender, birthday, residency, phone, email, circuitId };
    return voter;
  }
